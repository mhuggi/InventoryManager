...
class UpdatePriceRegressionTest {
    ...
    void testUpdatePriceSuccess() {
        // Add a product with known details
        ...
        // Execute the UpdatePrice command
        UpdatePrice updatePrice = new UpdatePrice(inventoryManager);
        updatePrice.execute();

        // Verify that the product's price was updated
    ...
    void testUpdatePriceProductNotFound() {
        // Leave the inventory empty
        // Simulate input for a invalid product ID
        ...
        // Verify that the output indicates the product was not found
        String output = testOut.toString();
